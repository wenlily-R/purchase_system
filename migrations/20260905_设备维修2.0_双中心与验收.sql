...
UPDATE approval_flow_config SET role='部门负责人', approver='zhangjl', label='部门主管-1级' WHERE biz_type='repair_plan' AND level_no=1 AND role='分管领导' AND max_amount=1000000 AND label='维修定损-1级';
